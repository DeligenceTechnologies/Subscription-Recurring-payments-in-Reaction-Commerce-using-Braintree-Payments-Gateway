...
describe("braintree-subscription/refund/create", function () {
  let sandbox;
  ...
  it("Should call braintree/refund/create with the proper parameters and return saved = true", function (done) {
    ...
    sandbox.stub(BraintreeSubsApi.apiCall, "createRefund", function () {
      return braintreeRefundResult;
    });
    let refundResult = null;
    let refundError = null;
    Meteor.call("braintree-subscription/refund/create", paymentMethod, paymentMethod.amount, function (error, result) {
      refundResult = result;
      refundError = error;
